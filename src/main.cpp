...
int64 nChainStartTime = 1374378310;
...
const string strMessageMagic = "Lebowskis Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Lebowskis
    bool fStrictPayToScriptHash = true; // Always active in Lebowskis
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lebowskis", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
//vMerkleTree: ea6fed5e2
        ...
        block.nVersion = 1;
        block.nTime    = 1374378315;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 23194623;
        ...
        assert(block.hashMerkleRoot == uint256("0x1e5eef510b575ece9854334f525ce97b8ecb2a272ef3f3e022638b2b1bddc640"));
